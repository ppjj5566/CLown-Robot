...
namespace servo {
  ...
  private:
    static constexpr float LOWER_HARD_LIMIT = 300.0f;   // The minimum micrsecond pulse to send
    static constexpr float UPPER_HARD_LIMIT = 2700.0f;  // The maximum microsecond pulse to send
