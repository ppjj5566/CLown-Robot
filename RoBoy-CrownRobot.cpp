...
int main(){
    ...
    xTaskCreate([](void* params){ static_cast<udp_server*>(server)->udp_server_task(static_cast<received_joystick_data*>(params)); }, "udp_server_task", 1024, joy_data, 0, NULL);
    xTaskCreate([](void* params){ static_cast<gaits*>(gait)->move(static_cast<received_joystick_data*>(params)); }, "movement_order_task", 1024, joy_data, 0, NULL);
